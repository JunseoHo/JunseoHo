...
|Date|Title|State|
|:--:|:---|:--:|
|Nov 2025|Data Processing System and Method Using Dynamic Reliability Tuning Algorithm|Pending|
|Oct 2025|Method for Visualizing Results of Cyber-Threat Detection Using Deep Learning, and a Computing Apparatus Implementing the Same|Pending|

# Award

|Date|Title|Host|Description|
|:--:|:--:|:--:|:--:|
|Feb 2025|Alumni Association President's Award|Myongji University|-|
